...
SECRET_KEY = "django-insecure-9xwqjx7)6irf1u7w4%q5z@tygvkba%^h9498(b#kk-#4w^hk%t"
...
# Docker settings
# DOCKER_CONFIG = {
#     'NETWORK': 'uctf_network',
#     'HOST_IP': 'your.server.ip',  # Replace with your server IP
#     'ALLOWED_PORTS': list(range(8000, 9000))
# }
